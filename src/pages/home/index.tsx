...
export function Home() {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    // Sanitização: Remove espaços em branco e impede navegação vazia.
    // Normalização: Converte para lowercase, pois IDs da CoinCap são minúsculos.
    const sanitizedInput = input.trim().toLowerCase();
    if (sanitizedInput === '') return;

    navigate(`/detail/${sanitizedInput}`);
  }
